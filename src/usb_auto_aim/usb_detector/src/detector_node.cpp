...
: Node("usb_detector", options)
{
  ...
  armors_pub_ = this->create_publisher<auto_aim_interfaces::msg::Armors>(
    "/usb_detector/armors", rclcpp::SensorDataQoS());
  ...
  marker_pub_ =
    this->create_publisher<visualization_msgs::msg::MarkerArray>("/usb_detector/marker", 10);
  ...
  cam_info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "/usb_cam_1/camera_info", rclcpp::SensorDataQoS(),
  ...
  img_sub_ = this->create_subscription<sensor_msgs::msg::Image>(
    "/usb_cam_1/image_raw", rclcpp::SensorDataQoS(),
...
std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
{
  ...
  // Init classifier
  auto pkg_path = ament_index_cpp::get_package_share_directory("usb_detector");
...
{
  lights_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugLights>("/usb_detector/debug_lights", 10);
  armors_data_pub_ =
    this->create_publisher<auto_aim_interfaces::msg::DebugArmors>("/usb_detector/debug_armors", 10);

  binary_img_pub_ = image_transport::create_publisher(this, "/usb_detector/binary_img");
  number_img_pub_ = image_transport::create_publisher(this, "/usb_detector/number_img");
  result_img_pub_ = image_transport::create_publisher(this, "/usb_detector/result_img");
}
